            ...
            <div class="group peer-has-[checked]:sidebar-open w-full">
                ...
                <aside
                    ...
                    <ul class="p-4 space-y-2">
                        <li><a href="index.html" class="block hover:text-yellow-400">Home</a></li>
                        <li><a href="about-us.html" class="block hover:text-yellow-400">About</a></li>
                        <li><a href="contact-us.html" class="block hover:text-yellow-400">Contact</a></li>
                        <li>
                            <div>
                ...
                <nav aria-label=" main navigation" class="flex h-full items-center">
                    <ul class="z-40 flex h-full items-center xl:space-x-3 space-x-1 ">
                        <li
                            ...
                            <a href="index.html" class="relative flex items-center justify-center px-2 lg:px-2
                        ...
                        <li
                            class="relative group text-black hover:text-[#137ec2] flex h-full text-base font-bold cursor-pointer">
                            <a href="about-us.html" class="relative flex items-center justify-center px-2 lg:px-2
                                        before:absolute before:-bottom-[28px] before:left-0 before:h-1 
                                        before:bg-[#137ec2] before:transition-all before:duration-300 
                                        group-hover:before:w-full">
                                About
                                                ...
                                                <div>
                                                    <ul class="text-lg text-[#939393] pl-6 mt-4 space-y-4">
                                                        <li
                                                            ...
                                                            <a href="mobile-app-development.html" class="text-base font-medium">Android App
                                                                Development</a>
                                                        </li>
                                                        <li
                                                            class="relative before:absolute before:w-2 before:h-2 before:bg-[#137ec2] before:top-[12px] before:left-[-20px] before:rotate-45 hover:before:rotate-180 duration-500 transition-all">
                                                            <a href="mobile-app-development.html" class="text-base font-medium">IOS App
                                                                Development</a>
                                                        </li>
                                                        <li
                                                            class="relative before:absolute before:w-2 before:h-2 before:bg-[#137ec2] before:top-[12px] before:left-[-20px] before:rotate-45 hover:before:rotate-180 duration-500 transition-all">
                                                            <a href="mobile-app-development.html" class="text-base font-medium">Hybrid App
                                                                Development</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div>
                                            <div class="py-8 flex flex-col justify-between h-full">
                                                <ul class="text-lg text-[#939393] pl-6 mt-4 space-y-4">
                                                    ...
                                                    <li
                                                        class="relative before:absolute before:w-2 before:h-2 before:bg-[#137ec2] before:top-[12px] before:left-[-20px] before:rotate-45 hover:before:rotate-180 duration-500 transition-all">
                                                        <a href="food-delivery-page.html" class="text-base font-medium">Food Delivery App</a>
                                                    </li>
                                                    <li
                                                        class="relative before:absolute before:w-2 before:h-2 before:bg-[#137ec2] before:top-[12px] before:left-[-20px] before:rotate-45 hover:before:rotate-180 duration-500 transition-all">
