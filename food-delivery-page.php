        ...
        <div class="grid md:grid-cols-2 grid-cols-1 gap-8">
          ...
          <div class="border-t border-[#d9dcdf] pt-5">
            ...
            <div class="mt-4 text-[#52606d] space-y-2 md:text-base text-sm">
              ...
              <p>We build apps for wearables using tools like Arduino, PlatformIO, and MBED—whether you're looking to
    ...
    <div class="!container flex xl:py-16 lg:py-14 md:py-12 sm:py-10 py-8">
      <div class="flex flex-col w-full">
        ...
        <div
          ...
          Our wide range of services ensures that your business gets everything it needs to grow — all in one place
        </div>
        <div
