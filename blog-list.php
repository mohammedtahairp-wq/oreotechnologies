<?php
    ...
    <section class="lg:px-20 px-4 md:py-14 py-6 relative bg-[url('../img/blog-bg.png')] bg-no-repeat bg-cover">
        <div class="max-w-7xl mx-auto">
            ...
            <div>
                <p class="text-center mt-4 text-medium text-black md:text-lg text-base tracking-[0.47px]"> Dive into comprehensive articles, expert opinions, and practical tips that help you stay informed and inspired in today’s fast-paced digital world.
