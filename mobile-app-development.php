<?php
    ...
    <section class="lg:px-20 px-4 py-14 relative  before:content-[''] before:absolute before:top-1/2 before:left-1/2 before:block before:w-[calc(100%-10px)] before:h-[calc(100%-10px)] before:-translate-x-1/2 before:-translate-y-1/2 before:transform before:bg-no-repeat before:bg-center before:bg-contain  before:aspect-[1/1] before:min-h-[100px]">
        <div class="max-w-4xl mx-auto">
            ...
            <div>
                <p class="text-center mt-4 text-black md:text-lg  text-sm tracking-[0.47px]">As a leading mobile app development company, we’ve been helping businesses of all sizes turn their ideas into reality since 2009. We offer a full range of services from designing to maintenance.</p>
            </div>
    ...
    <section class="lg:px-20 px-4 md:py-14 py-0">
                ...
                <div class="grid md:grid-cols-2 grid-cols-1 gap-8">
                    ...
                    <div class="border-t border-[#d9dcdf] pt-5">
                        ...
                        <div class="mt-4 text-[#52606d] space-y-2 md:text-base text-sm">
                            ...
                            <p>We build apps for wearables using tools like Arduino, PlatformIO, and MBED—whether you're looking to create the next great health monitoring app, help your audience stay productive, or track sleeping patterns.</p>
                         </div>
                    </div>
                </div>
            </div>
     ...
     <!-- features section -->
    <section class="lg:px-20 px-4 py-10 bg-[linear-gradient(to_bottom,_#171624_63%,_#26374a_100%)]">
        <div>
            ...
            <div class=" mt-10">
                ...
                <div class="swiper mySwiperLogo my-20">
      ...
      <div class="w-full group">
            <div class="text-center">
              ...
              <div class="md:pb-20 pb-5">
                <div class="swiper storiesSwiper2 flex md:pt-12! pt-5! w-full overflow-visible!">
                ...
                <div class="md:w-1/2 w-full space-y-8">
                    <div class="flex items-start gap-4 ">
                        ...
                        <div>
                            ...
                            <p class="text-white md:text-base text-sm font-normal mb-4 tracking-wider">Leverage our proven playbooks, agile delivery, and cross-functional teams to launch MVPs and platforms 30–50% faster, without sacrificing quality or scalability.</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-white md:text-base text-sm font-normal mb-4 tracking-wider">Whether it’s through  team augmentation or end-to-end delivery, our delivery pods embed into your workflow like an in-house team, bringing product strategy, design, and engineering capabilities tailored to your roadmap.</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-white md:text-base text-sm font-normal mb-4 tracking-wider">With over 2,500 successful projects and a 95% milestone adherence rate, we’ve perfected the art of launching products on time—whether it's a startup MVP or an enterprise transformation. </p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-white md:text-base text-sm font-normal mb-4 tracking-wider">We specialize in building custom LLM applications , RAG pipelines, and AI agents that solve real problems—reducing operational load, accelerating insights, and enabling autonomous decision-making.  </p>
                        </div>
                    </div>
                </div>
            </div>
