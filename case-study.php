    ...
    <section class="lg:px-20 px-4 py-14 bg-[url('../img/case-study-bg.webp')] bg-cover bg-no-repeat ">
        <div>
            <div class="text-center md:space-y-6 space-y-4">
                <h6 class="text-[#222222] md:text-5xl text-base leading-normal"><span class="font-bold">We craft tomorrow’s </span>digital <br> experiences products, and ventures</h6>
